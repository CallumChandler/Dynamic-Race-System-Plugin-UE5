...
#include "GSO_ProjectSportsCar.h"
#include "GSO_ProjectSportsWheelFront.h"
#include "GSO_ProjectSportsWheelRear.h"
...
AGSO_ProjectSportsCar::AGSO_ProjectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGSO_ProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGSO_ProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGSO_ProjectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGSO_ProjectSportsWheelRear::StaticClass();
