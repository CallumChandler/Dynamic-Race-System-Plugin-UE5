...
#include "GSO_ProjectOffroadCar.h"
#include "GSO_ProjectOffroadWheelFront.h"
#include "GSO_ProjectOffroadWheelRear.h"
...
AGSO_ProjectOffroadCar::AGSO_ProjectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGSO_ProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGSO_ProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGSO_ProjectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGSO_ProjectOffroadWheelRear::StaticClass();
